...
const JobSidebar = ({}: JobSidebarProps) => {
  return (
    <aside className="hidden sticky top-[var(--navbar-height)] bg-white h-[calc(100vh-var(--navbar-height))] lg:flex lg:flex-col">
      <div className="flex flex-col gap-5 p-5 border-b border-zinc-200">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-1 lg:flex-wrap">
            ...
            />
            <JobLocation icon={<Calendar size={14} />} text={'10 days age'} />
            <JobLocation
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm flex items-center gap-1 font-semibold">
            <CircleCheck size={'1rem'} fill="#fff" color="#45d95d" /> 5 of 6
            skills match with you - you may be a good fit 💡
          </p>
          <div className="flex items-center gap-3">
      ...
      <div className="p-5 flex flex-col">
        ...
        <div className="flex flex-col gap-3 mt-4">
          ...
          <JobInfo
            title="Category"
            description="Creative / Design - IT Software development - Gaming"
          />
        </div>
      </div>
    </aside>
